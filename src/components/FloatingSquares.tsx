...
const squarePositionsLogin: SquareData[] = [
  { x: 50, y: 200, width: 90, height: 90, icon: <JavaIcon size={50} /> },
  { x: 430, y: 700, width: 90, height: 90, icon: <RubyIcon size={50} /> },
  { x: 600, y: 300, width: 90, height: 90, icon: <PythonIcon size={50} /> },
  { x: 200, y: 300, width: 90, height: 90, icon: <JSIcon size={50} /> },
  { x: 500, y: 300, width: 70, height: 70, className: "squareOp50" },
  { x: 30, y: 830, width: 90, height: 90, icon: <DartIcon size={50} /> },
  { x: 100, y: 500, width: 60, height: 60, icon: <KotlinIcon size={30} /> },
  { x: 600, y: 500, width: 60, height: 60, icon: <GOIcon size={30} /> },
  { x: 350, y: 100, width: 60, height: 60, icon: <CIcon size={30} /> },
  { x: 150, y: 400, width: 70, height: 70, className: "squareOp50" },
  {
    x: 650,
    y: 800,
    width: 70,
  ...
  { x: 620, y: 750, width: 70, height: 70, className: "squareOp50" },
  {
    x: 650,
    y: 50,
    width: 50,
  ...
  { x: 600, y: 70, width: 70, height: 70, className: "squareOp50" },
  { x: 250, y: 250, width: 50, height: 50, className: "squareBorder" },
  { x: 250, y: 750, width: 70, height: 70, className: "squareBorder" },
  { x: 450, y: 880, width: 70, height: 70, className: "squareBorder" },
  { x: 450, y: 500, width: 70, height: 70, className: "squareBorder" },
  { x: 150, y: 100, width: 70, height: 70, className: "squareBorder" },
  { x: 250, y: 650, width: 70, height: 70, className: "squareBorder" },
];
