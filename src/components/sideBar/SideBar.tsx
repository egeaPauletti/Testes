...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col items-center h-screen w-max absolute left-0 top-0 z-100">
      <motion.nav
        layout
        className="h-full border-r-1 border-[#ffffff20] bg-[#1a1a1a80] p-2 gap-10 flex flex-col"
        style={{
