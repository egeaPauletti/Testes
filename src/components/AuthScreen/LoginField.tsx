...
export default function LoginField() {
  ...
  return (
    <div className="absolute w-6/10 h-full left-[40%] flex flex-col gap-15 justify-center items-center animationFadeInAuth whiteColor">
      ...
      <Link to={"/home"}>
        <button className="relative cursor-pointer 2xl:py-[1.5%] 2xl:px-70 text-center font-barlow inline-flex justify-center 2xl:text-base text-sm px-50 py-[1.25%] text-white rounded-lg border-solid transition-transform duration-300 ease-in-out group outline-offset-4  focus:outline-[#2ea98c] focus:outline-offset-4 overflow-hidden hover:opacity-75 bg-[#2ea98c]">
